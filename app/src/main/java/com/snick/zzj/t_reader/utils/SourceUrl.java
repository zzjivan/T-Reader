...
public class SourceUrl {
    ...
    public static final String newsThemeRoot = "https://news-at.zhihu.com/api/4/";
    public static final String newsThemeList = "themes";
    public static final String newsThemeItemTag = "theme";
}
